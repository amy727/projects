...
class CNN(torch.nn.Module):
    def __init__(self, num_bins): 
        ...
        self.conv1 = torch.nn.Conv2d(3, 16, stride=4, kernel_size=(7,7), padding=1) # 3 input channels, 16 output channels
        self.bn1 = torch.nn.BatchNorm2d(16) 
        self.pool1 = torch.nn.MaxPool2d((3,3),stride=3)
        self.relu = torch.nn.ReLU()
        self.dropout1 = torch.nn.Dropout(0.1)

        self.conv3 = torch.nn.Conv2d(16, 32, stride=1, kernel_size=(5,5), padding=1) 
        self.bn3 = torch.nn.BatchNorm2d(32)  
        self.pool2 = torch.nn.MaxPool2d((3,3), stride=3)
        self.relu2 = torch.nn.ReLU() 
        self.dropout2 = torch.nn.Dropout(0.1)

        self.conv2 = torch.nn.Conv2d(32, num_bins, kernel_size=(1,5))
...
class dataloader(torch.utils.data.Dataset):
    ...
    def normalize_to_zero_mean(self):
        ...
        std = self.images.std(axis=(0,2,3), keepdims=True)
