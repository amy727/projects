...
class CNN(torch.nn.Module):
    def __init__(self, num_bins): 
        ...
        self.conv2 = torch.nn.Conv2d(32,num_bins, kernel_size=(1,8))
...
if __name__ == "__main__": 
    ...
    optimizer = torch.optim.Adam(params, lr=2e-3, weight_decay=0.0) #initialize our optimizer (Adam, an alternative to stochastic gradient descent)
